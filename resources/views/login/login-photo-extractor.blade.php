...
@push('link-image')
{{route('photo.extractor.login')}}
@endpush

@section('form-login')
<form class="login-form" action="{{route('photo.extractor.login.post')}}" name="loginPhotoExtractor" method="post">
    {{ csrf_field() }}
    <div class="form-title text-center">
        <span class="form-title">Photo Extractor</span><br>
    ...
    <div class="form-group">
        ...
        <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="Nama user" name="email" /> </div>
    <div class="form-group">
...
<script>
  $("form[name=loginPhotoExtractor]").validate({
